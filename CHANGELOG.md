...
### Other
- document and todo!() unimplemented emit action variants ([#103](https://github.com/joshuadavidthomas/kbd/pull/103))
- implement serde feature for kbd types ([#102](https://github.com/joshuadavidthomas/kbd/pull/102))
