...
impl TaoKeyExt for KeyCode {
    ...
    fn to_key(&self) -> Option<Key> {
        match self {
            ...
            // ModifierSet — tao uses SuperLeft/SuperRight where kbd uses MetaLeft/MetaRight
...
mod tests {
    ...
    #[test]
    fn empty_modifiers() {
        assert_eq!(ModifiersState::empty().to_modifiers(), ModifierSet::NONE);
    }
