...
fn parse_key_token(token: &str) -> Option<Key> {
    ...
    match upper.as_str() {
        ...
        "PRINTSCREEN" | "PRTSC" | "PRINT" | "SYSRQ" => Some(Key::PrintScreen),
        "SCROLLLOCK" => Some(Key::ScrollLock),
        "PAUSE" | "BREAK" => Some(Key::Pause),
        "NUMLOCK" => Some(Key::NumLock),
        "CONTEXTMENU" | "MENU" | "COMPOSE" => Some(Key::ContextMenu),
        ...
        "MEDIANEXTTRACK" | "NEXTTRACK" | "NEXTSONG" => Some(Key::MediaNextTrack),
        "MEDIAPREVTRACK" | "PREVTRACK" | "PREVIOUSSONG" => Some(Key::MediaPrevTrack),
        "MEDIARECORD" => Some(Key::MediaRecord),
        "MEDIAFASTFORWARD" => Some(Key::MediaFastForward),
        "MEDIAREWIND" => Some(Key::MediaRewind),
        ...
        "BROWSERFAVORITES" | "BROWSERBOOKMARKS" => Some(Key::BrowserFavorites),
        "BROWSERSTOP" => Some(Key::BrowserStop),
        "LAUNCHMAIL" | "MAIL" => Some(Key::LaunchMail),
        "LAUNCHAPP1" | "CALCULATOR" | "CALC" => Some(Key::LaunchApp1),
        "LAUNCHAPP2" | "FILEMANAGER" | "FILES" => Some(Key::LaunchApp2),
        "POWER" => Some(Key::Power),
        "SLEEP" => Some(Key::Sleep),
        "WAKEUP" | "WAKE" => Some(Key::WakeUp),
        "EJECT" => Some(Key::Eject),
        "BRIGHTNESSDOWN" => Some(Key::BrightnessDown),
        "BRIGHTNESSUP" => Some(Key::BrightnessUp),
        "NUMPADEQUAL" | "KPEQUAL" => Some(Key::NumpadEqual),
        "NUMPADCOMMA" | "KPCOMMA" => Some(Key::NumpadComma),
        _ => None,
    }
}
