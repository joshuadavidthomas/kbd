...
impl KeyCodeExt for KeyCode {
    ...
    fn to_key(self) -> Key {
        match self {
            ...
            KeyCode::KEY_SYSRQ => Key::PrintScreen,
            KeyCode::KEY_SCROLLLOCK => Key::ScrollLock,
            KeyCode::KEY_PAUSE => Key::Pause,
            KeyCode::KEY_NUMLOCK => Key::NumLock,
            KeyCode::KEY_COMPOSE => Key::ContextMenu,
            KeyCode::KEY_MUTE => Key::VolumeMute,
            KeyCode::KEY_VOLUMEDOWN => Key::VolumeDown,
            KeyCode::KEY_VOLUMEUP => Key::VolumeUp,
            KeyCode::KEY_PLAYPAUSE => Key::MediaPlayPause,
            KeyCode::KEY_STOPCD => Key::MediaStop,
            KeyCode::KEY_NEXTSONG => Key::MediaNextTrack,
            KeyCode::KEY_PREVIOUSSONG => Key::MediaPrevTrack,
            KeyCode::KEY_RECORD => Key::MediaRecord,
            KeyCode::KEY_FASTFORWARD => Key::MediaFastForward,
            KeyCode::KEY_REWIND => Key::MediaRewind,
            KeyCode::KEY_BACK => Key::BrowserBack,
            KeyCode::KEY_FORWARD => Key::BrowserForward,
            KeyCode::KEY_REFRESH => Key::BrowserRefresh,
            KeyCode::KEY_HOMEPAGE => Key::BrowserHome,
            KeyCode::KEY_SEARCH => Key::BrowserSearch,
            KeyCode::KEY_BOOKMARKS => Key::BrowserFavorites,
            KeyCode::KEY_STOP => Key::BrowserStop,
            KeyCode::KEY_MAIL => Key::LaunchMail,
            KeyCode::KEY_CALC => Key::LaunchApp1,
            KeyCode::KEY_FILE => Key::LaunchApp2,
            KeyCode::KEY_POWER => Key::Power,
            KeyCode::KEY_SLEEP => Key::Sleep,
            KeyCode::KEY_WAKEUP => Key::WakeUp,
            KeyCode::KEY_EJECTCD => Key::Eject,
            KeyCode::KEY_BRIGHTNESSDOWN => Key::BrightnessDown,
            KeyCode::KEY_BRIGHTNESSUP => Key::BrightnessUp,
            KeyCode::KEY_KPEQUAL => Key::NumpadEqual,
            KeyCode::KEY_KPCOMMA => Key::NumpadComma,
            _ => Key::Unknown,
        }
    }
}
...
impl EvdevKeyExt for Key {
    ...
    fn to_key_code(self) -> KeyCode {
        match self {
            ...
            Key::ContextMenu => KeyCode::KEY_COMPOSE,
            Key::VolumeMute => KeyCode::KEY_MUTE,
            Key::VolumeDown => KeyCode::KEY_VOLUMEDOWN,
            Key::VolumeUp => KeyCode::KEY_VOLUMEUP,
            Key::MediaPlayPause => KeyCode::KEY_PLAYPAUSE,
            Key::MediaStop => KeyCode::KEY_STOPCD,
            Key::MediaNextTrack => KeyCode::KEY_NEXTSONG,
            Key::MediaPrevTrack => KeyCode::KEY_PREVIOUSSONG,
            Key::MediaRecord => KeyCode::KEY_RECORD,
            Key::MediaFastForward => KeyCode::KEY_FASTFORWARD,
            Key::MediaRewind => KeyCode::KEY_REWIND,
            Key::BrowserBack => KeyCode::KEY_BACK,
            Key::BrowserForward => KeyCode::KEY_FORWARD,
            Key::BrowserRefresh => KeyCode::KEY_REFRESH,
            Key::BrowserHome => KeyCode::KEY_HOMEPAGE,
            Key::BrowserSearch => KeyCode::KEY_SEARCH,
            Key::BrowserFavorites => KeyCode::KEY_BOOKMARKS,
            Key::BrowserStop => KeyCode::KEY_STOP,
            Key::LaunchMail => KeyCode::KEY_MAIL,
            Key::LaunchApp1 => KeyCode::KEY_CALC,
            Key::LaunchApp2 => KeyCode::KEY_FILE,
            ...
            Key::NumpadEqual => KeyCode::KEY_KPEQUAL,
            Key::NumpadComma => KeyCode::KEY_KPCOMMA,
